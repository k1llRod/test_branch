...
$pdf->SetTitle('Acta inicial');
$pdf->SetSubject('Auto inicial PDF');
...
$pdf->AddPage();
$respuesta = cadetesControlador::impresion_auto_inicial_pdf();
...
$html1 = <<<EOF
	...
	<div style="margin-top:20px;">
		...
		<table  style="font-size:11px; text-transform: uppercase;">
			<tr>
				<td width="20%"></td>
				<td width="60%" style="text-align:center; font-family:Monotype Corsiva; "><strong style="text-transform: uppercase;">$item[titulo] DE PROCESO SUMARIO INTERNO</strong></td>
				<td width="20%"></td>
			</tr>
			<tr>
				<td width="20%"></td>
				<td width="60%" style="text-align:center; font-family:Monotype Corsiva;"><strong>CASO: CRD N° $item[id_sancion]/$item[id_cadete]</strong></td>
				<td width="20%"></td>
			</tr>
		</table>
	</div>
...
$html3 = <<<EOF
	...
	<div style="margin-top:20px;">
		<br><br>
		<table  style="font-size:8px; text-transform: uppercase;">
			<tr>
				<td width="20%"></td>
				<td width="60%" style="text-align:center; font-family:Monotype Corsiva; ">Cnl. DESP. Augusto Juan Russo Sandoval</td>
				<td width="20%"></td>
			</tr>
			<tr>
				<td width="20%"></td>
				<td width="60%" style="text-align:center; font-family:Monotype Corsiva;"><strong>PRESIDENTE DE LA COMISION DE REGIMEN DISCIPLINARIO ACADEMIA NACIONAL DE POLICIAS</strong></td>
				<td width="20%"></td>
			</tr>
		</table>
	</div>
